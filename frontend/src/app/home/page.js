    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full h-full">
          <p className="text-lg text-gray-600 mb-10">Start your AI-powered diagnosis here.</p>
  
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
            {/* Predict Disease */}
            <div className="p-8 bg-white shadow-lg rounded-xl flex flex-col items-center w-full h-64">
            ...
            <div className="p-8 bg-white shadow-lg rounded-xl flex flex-col items-center w-full h-64">
              ...
              <p className="text-gray-600 text-center">Get expert advice from a real doctor.</p>
            ...
            <div className="p-8 bg-white shadow-lg rounded-xl flex flex-col items-center w-full h-64">
              ...
              <p className="text-gray-600 text-center">Check your previous medical records.</p>
